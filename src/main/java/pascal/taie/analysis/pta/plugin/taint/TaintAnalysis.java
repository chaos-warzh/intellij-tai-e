...
public class TaintAnalysis extends CompositePlugin {
    ...
    private void reportTaintFlows() {
        ...
        // save last taint flows
        taintFlowsRcd.clear();
        taintFlowsRcd.addAll(taintFlows);
    }

    private static final Set<TaintFlow> taintFlowsRcd = pascal.taie.util.collection.Sets.newOrderedSet();
    public static Set<TaintFlow> getTaintFlows() {
        return taintFlowsRcd;
    }
